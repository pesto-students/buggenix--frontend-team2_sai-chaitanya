...
const TicketPreviewContainer = (props) => {
    ...
    const {updateTicket, userRole, projectsList, usersList, deleteTicket, ticketList, onDelete, isLoading, isError, checkedTicketIds, onCheck, selectedTicket, onSelect, onCheckAll, addConversation} = props;
    ...
    return (
        <div className = {styles.ticketPreviewContainer}>
            ...
            <div className = {styles.conversations}>
                <TicketInbox userRole = {userRole} deleteTicket = {deleteTicket} addConversation = {addConversation} updateTicket = {updateTicket}  projectsList = {projectsList} ticketList = {ticketList} isLoading = {isLoading} usersList = {usersList} onDelete = {onDelete} selectedTicket = {selectedTicket}/>
            </div>
        </div>
    )
}
